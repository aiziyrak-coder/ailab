...
CRITERIA = [
    ...
    E("Psoriasis vulgaris", ["psoriaz", "psoriasis", "псориаз"], "psoriaziform",
      ...
      ["spongiosis", "acantholysis", "subepidermal_blister", "granuloma", "pagetoid_spread"],
      min_essential=3),
    E("Pustulyoz psoriaz", ["pustul", "пустулез"], "psoriaziform",
      ["spongiform_pustule", "neutrophils_in_corneum", "parakeratosis"],
      ["regular_elongated_rete", "munro_microabscess"],
    ...
    E("Allergik kontakt dermatit", ["allergik kontakt", "allergic contact", "аллергический контактный"],
      ...
      ["acantholysis", "granuloma", "atypical_lymphocytes"], min_essential=2,
    ...
    E("Pemphigus vulgaris", ["pemphigus vulgaris", "pemfigus vulgaris", "пузырчатка обыкновенная",
      ...
      ["subepidermal_blister", "granuloma", "pagetoid_spread"], min_essential=2),
    E("Pemphigus foliaceus", ["foliaceus", "листовидн"], "pufakli",
      ["acantholysis"], ["neutrophils_in_corneum", "eosinophils"],
      ["subepidermal_blister", "granuloma"], min_essential=1),
    E("Hailey-Hailey kasalligi", ["hailey", "хейли"], "pufakli",
      ["acantholysis"], ["dyskeratosis", "acanthosis"],
      ["subepidermal_blister", "band_like_infiltrate"], min_essential=1),
