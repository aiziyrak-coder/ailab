...
SOURCES = {
    ...
    "roeken_atlas_ru": {
        "label": "Атлас по дерматологии, М. Рёкен (klinika kutubxonasi)",
        "domain": "skin",
        "tier": 1,
        "clinic": True,
        "weight": 0.07,
        "prefix": "Рёкен атлас дерматологии клинико-морфологический. ",
    },
    "platonova_atlas_ru": {
        "label": "Дерматовенерология. Атлас, Платонова–Бакулев–Утц (klinika kutubxonasi)",
        "domain": "skin",
        "tier": 1,
        "clinic": True,
        "weight": 0.07,
        "prefix": "Дерматовенерология атлас Платонова Бакулев Утц. ",
    },
    "clinical_derm_ru": {
        "label": "Клиническая дерматология (klinika kutubxonasi)",
        "domain": "skin",
        "tier": 1,
        "clinic": True,
        "weight": 0.06,
        "prefix": "Клиническая дерматология руководство. ",
    },
    "dermatoscopy2_ru": {
        "label": "Дерматоскопия, atlas (klinika kutubxonasi)",
        "domain": "skin",
        "tier": 1,
        "clinic": True,
        # Dermatoskopiya boshqa modallik: teri yuzasi, gistologik kesma emas.
...
_DX_TERM_HINTS = (
    ...
    # ─── O'zbekcha kalitlar ───────────────────────────────────────────────────
    # Qoralama o'zbek tilida yoziladi: "bazal hujayrali karsinoma" ingliz
    # kalitlariga tushmasdi va maqsadli qidiruv umuman ishga tushmasdi.
    ("bazal hujayra", "basal cell carcinoma nodular superficial infiltrative peripheral palisading retraction"),
    ("bazalioma", "basal cell carcinoma palisading clefting mucinous stroma"),
    ("bazaliom", "basal cell carcinoma palisading clefting mucinous stroma"),
    ("yassi hujayra", "squamous cell carcinoma keratinocyte atypia keratin pearls invasion"),
    ("yassi epiteli", "squamous cell carcinoma in situ Bowen disease full thickness atypia"),
    ("keratoz", "seborrheic keratosis actinic keratosis horn cysts basaloid acanthosis solar elastosis"),
    ("so'gal", "verruca vulgaris koilocytes papillomatosis hypergranulosis HPV"),
    ("sugal", "verruca vulgaris koilocytes papillomatosis hypergranulosis HPV"),
    ("temiratki", "lichen planus lichenoid interface band-like infiltrate Civatte bodies sawtooth"),
    ("granulem", "granuloma annulare sarcoidosis necrobiosis palisading granulomatous dermatitis"),
    ("tomir yalligl", "vasculitis leukocytoclastic fibrinoid necrosis vessel wall damage"),
    # ─── Yetishmagan kasalliklar (klinika kutubxonasining kuchli tomoni) ──────
    ("ekzema", "eczema spongiotic dermatitis spongiosis exocytosis lymphocytes vesicle acanthosis"),
    ("экзем", "eczema spongiotic dermatitis spongiosis intercellular oedema"),
    ("eczema", "eczema spongiotic dermatitis spongiosis exocytosis parakeratosis"),
    ("spongio", "spongiotic dermatitis spongiosis intraepidermal oedema exocytosis vesicle"),
    ("dermatit", "spongiotic dermatitis contact allergic atopic seborrhoeic eczema histology"),
    ("pemfigus", "pemphigus vulgaris acantholysis suprabasal cleft tombstone basal keratinocytes"),
    ("pufak", "bullous dermatosis subepidermal blister pemphigoid acantholysis level of split"),
    ("bullez", "bullous pemphigoid subepidermal blister eosinophils dermatitis herpetiformis"),
    ("pemphig", "pemphigus pemphigoid acantholysis subepidermal suprabasal split"),
    ("volchank", "lupus erythematosus interface dermatitis follicular plugging basement membrane thickening"),
    ("lupus", "lupus erythematosus vacuolar interface perivascular periadnexal lymphocytes mucin"),
    ("qizil bo'richa", "lupus erythematosus interface dermatitis follicular plugging mucin deposition"),
    ("sklerodermi", "scleroderma morphoea thickened sclerotic collagen loss of adnexa"),
    ("mikoz", "dermatophytosis fungal hyphae PAS stain sandwich sign hyperkeratosis"),
    ("qo'ziqorin", "dermatophyte fungal hyphae PAS stain stratum corneum"),
    ("akne", "acne vulgaris folliculitis comedo perifollicular inflammation rosacea"),
    ("rozatse", "rosacea perifollicular lymphohistiocytic infiltrate Demodex telangiectasia"),
    ("sarkoidoz", "sarcoidosis naked epithelioid granuloma asteroid body Schaumann body"),
    ("sil ", "cutaneous tuberculosis lupus vulgaris caseating granuloma acid fast bacilli"),
    ("tuberkul", "cutaneous tuberculosis caseating granuloma Langhans giant cells"),
    ("sifilis", "syphilis plasma cell infiltrate endothelial swelling psoriasiform lichenoid"),
    ("alopetsi", "alopecia hair follicle miniaturisation peribulbar infiltrate catagen telogen"),
    ("vitiligo", "vitiligo loss of melanocytes basal layer Melan-A epidermal pigment"),
    ("pigment", "pigmentation disorder melanin incontinence melanophages basal hyperpigmentation"),
)
...
_DX_TERM_RU = {
    ...
    "bazal hujayra": "базальноклеточный рак кожи базалиома палисадообразное расположение ретракция стромы гистология",
    "bazalioma": "базалиома базальноклеточная карцинома гистологическая картина",
    "bazaliom": "базалиома базальноклеточная карцинома гистологическая картина",
    "yassi hujayra": "плоскоклеточный рак кожи роговые жемчужины атипия кератиноцитов гистология",
    "yassi epiteli": "плоскоклеточный рак in situ болезнь Боуэна атипия эпидермиса",
    "keratoz": "себорейный кератоз актинический кератоз роговые кисты акантоз гистология",
    "so'gal": "бородавка вульгарная койлоциты папилломатоз гипергранулёз гистология",
    "sugal": "бородавка вульгарная койлоциты папилломатоз гистология",
    "temiratki": "красный плоский лишай лихеноидная реакция полосовидный инфильтрат гистология",
    "granulem": "гранулёма кольцевидная саркоидоз некробиоз палисадообразная гистология",
    "tomir yalligl": "васкулит лейкоцитокластический фибриноидный некроз гистология",
    "ekzema": "экзема спонгиотический дерматит спонгиоз экзоцитоз лимфоцитов везикулы гистология",
    "экзем": "экзема спонгиоз межклеточный отёк эпидермиса патоморфология",
    "eczema": "экзема спонгиотический дерматит спонгиоз гистология",
    "spongio": "спонгиоз межклеточный отёк эпидермиса спонгиотические полости экзоцитоз",
    "dermatit": "дерматит контактный аллергический атопический себорейный спонгиоз гистология",
    "pemfigus": "пузырчатка вульгарная акантолиз надбазальная щель ряд надгробных камней гистология",
    "pufak": "буллёзный дерматоз субэпидермальный пузырь уровень расщепления акантолиз",
    "bullez": "буллёзный пемфигоид субэпидермальный пузырь эозинофилы герпетиформный дерматит",
    "pemphig": "пузырчатка пемфигоид акантолиз субэпидермальное расщепление гистология",
    "volchank": "красная волчанка интерфейс-дерматит фолликулярные пробки утолщение базальной мембраны",
    "lupus": "красная волчанка вакуольная дистрофия периваскулярный периаднексальный инфильтрат муцин",
    "qizil bo'richa": "красная волчанка интерфейс-дерматит фолликулярные пробки муцин",
    "sklerodermi": "склеродермия морфея утолщённый склерозированный коллаген утрата придатков кожи",
    "mikoz": "дерматофитии грибковые гифы PAS-окраска гиперкератоз гистология",
    "qo'ziqorin": "грибковые гифы в роговом слое PAS-окраска гистология",
    "akne": "акне вульгарные фолликулит комедон перифолликулярное воспаление гистология",
    "rozatse": "розацеа перифолликулярный лимфогистиоцитарный инфильтрат демодекс телеангиэктазии",
    "sarkoidoz": "саркоидоз голые эпителиоидные гранулёмы тельца Шаумана астероидные тельца",
    "sil ": "туберкулёз кожи волчанка обыкновенная казеозный некроз гранулёма гистология",
    "tuberkul": "туберкулёз кожи казеозная гранулёма гигантские клетки Лангханса",
    "sifilis": "сифилис плазмоклеточный инфильтрат набухание эндотелия псориазиформный лихеноидный",
    "alopetsi": "алопеция миниатюризация фолликулов перибульбарный инфильтрат катаген телоген",
    "vitiligo": "витилиго отсутствие меланоцитов базальный слой Melan-A пигмент эпидермиса",
    "pigment": "нарушения пигментации недержание меланина меланофаги базальная гиперпигментация",
}
